...
import com.savemaster.savefromfb.streams.WebMReader.SimpleBlock;
import com.savemaster.savefromfb.streams.WebMReader.WebMTrack;
...
public class OggFromWebMWriter implements Closeable {
	...
	private WebMReader.WebMTrack webm_track = null;
	private WebMReader.Segment webm_segment = null;
	private WebMReader.Cluster webm_cluster = null;
	private WebMReader.SimpleBlock webm_block = null;
