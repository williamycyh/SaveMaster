...
import static com.savemaster.savefromfb.db.stream.model.StreamStateEntity.JOIN_STREAM_ID;
import static com.savemaster.savefromfb.db.stream.model.StreamStateEntity.STREAM_STATE_TABLE;
