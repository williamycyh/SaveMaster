...
public final class NotificationConstants {
    ...
    public static final int[] ACTION_ICONS = {
            0,
            R.drawable.ic_control_savemasterdown_previous_white_24dp,
            R.drawable.ic_control_savemasterdown_next_white_24dp,
            R.drawable.savemasterdown_ic_fast_rewind,
            R.drawable.savemasterdown_ic_fast_forward,
            R.drawable.ic_control_savemasterdown_previous_white_24dp,
            R.drawable.ic_control_savemasterdown_next_white_24dp,
            R.drawable.savemasterdown_ic_pause_white_24dp,
            R.drawable.savemasterdown_ic_hourglass_top_white_24dp,
            R.drawable.savemasterdown_ic_repeat_white_24dp,
            R.drawable.savemasterdown_ic_shuffle_white_24dp,
            R.drawable.ic_closesavemasterdown__white_24dp,
    };
    ...
    public static final int[] SLOT_PREF_KEYS = {
            R.string.savemasterdown_notification_slot_0_key,
            R.string.savemasterdown_notification_slot_1_key,
            R.string.savemasterdown_notification_slot_2_key,
            R.string.savemasterdown_notification_slot_3_key,
            R.string.savemasterdown_notification_slot_4_key,
    };
    ...
    public static final int[] SLOT_COMPACT_PREF_KEYS = {
            R.string.savemasterdown_notification_slot_compact_0_key,
            R.string.savemasterdown_notification_slot_compact_1_key,
            R.string.savemasterdown_notification_slot_compact_2_key,
    };
        ...
        switch (action) {
            ...
            case PLAY_PAUSE_BUFFERING:
                return Localization.concatenateStrings(
                        context.getString(R.string.exo_controls_play_description),
                        context.getString(R.string.exo_controls_pause_description),
                        context.getString(R.string.savemasterdown_notification_action_buffering));
            case REPEAT:
                return context.getString(R.string.savemasterdown_notification_action_repeat);
            case SHUFFLE:
                return context.getString(R.string.savemasterdown_notification_action_shuffle);
            case CLOSE:
                return context.getString(R.string.close);
            case NOTHING:
            default:
                return context.getString(R.string.savemasterdown_notification_action_nothing);
        }
    }
