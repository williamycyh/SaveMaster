...
public class PlayQueueItem implements Serializable {
	...
	public PlayQueueItem(@NonNull final StreamInfo info) {
		...
		this(info.getName(), info.getUrl(), info.getServiceId(), info.getDuration(), info.getThumbnailUrl(), info.getUploaderName(), info.getStreamType());
	...
	public PlayQueueItem(@NonNull final StreamInfoItem item) {
		this(item.getName(), item.getUrl(), item.getServiceId(), item.getDuration(), item.getThumbnailUrl(), item.getUploaderName(), item.getStreamType());
	}
	
	private PlayQueueItem(@Nullable final String name, @Nullable final String url, final int serviceId, final long duration, @Nullable final String thumbnailUrl, @Nullable final String uploader, @NonNull final StreamType streamType) {
