...
public class Utility {
	...
	public static int getBackgroundForFileType(Context ctx, FileType type) {
		int colorRes = R.color.savemasterdown_light_blue;
		/*switch (type) {
			case MUSIC:
			...
			case VIDEO:
				...
				break;
			default:
				colorRes = R.color.app_primary_color;
		}*/
	...
	public static int getForegroundForFileType(Context ctx, FileType type) {
		int colorRes = R.color.savemasterdown_app_primary_color;
		/*switch (type) {
			case MUSIC:
	...
	public static int getIconForFileType(FileType type) {
		switch (type) {
			case MUSIC:
				return R.drawable.savemasterdown_ic_msc_download;
			default:
			case VIDEO:
				return R.drawable.savemasterdown_ic_video_download;
		}
	}
