package com.savemaster.download;

import android.content.Context;
import android.preference.PreferenceManager;

import savemaster.save.master.pipd.downloader.Downloader;
import savemaster.save.master.pipd.downloader.Request;
import savemaster.save.master.pipd.downloader.Response;
...
import com.savemaster.savefromfb.util.CookieUtils;
...
public class DownloaderImpl extends Downloader {
	...
	public String getCookies(final String url) {
		...
		String recaptchaCookie = getCookie(UIReCaptchaActivity.RECAPTCHA_COOKIES_KEY);
    ...
    public void updateTubeRestrictedModeCookies(final Context context) {
        String restrictedModeEnabledKey = context.getString(R.string.youtube_restricted_mode_enabled);
        boolean restrictedModeEnabled = PreferenceManager.getDefaultSharedPreferences(context).getBoolean(restrictedModeEnabledKey, false);
        updateTubeRestrictedModeCookies(restrictedModeEnabled);
    }
    
    public void updateTubeRestrictedModeCookies(final boolean youtubeRestrictedModeEnabled) {
