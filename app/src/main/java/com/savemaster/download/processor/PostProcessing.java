...
import com.savemaster.download.io.ChunkFileInputStream;
import com.savemaster.download.io.CircularFileWriter;
import com.savemaster.download.io.ProgressReport;
		...
		if (worksOnSameFile) {
			...
			try {
				...
				if (test(sources)) {
					...
					CircularFileWriter.OffsetChecker checker = () -> {
