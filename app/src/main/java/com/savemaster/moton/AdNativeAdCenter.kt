...
//            nativeAdLoader.loadAd()
    ...
    private fun createNativeAdViewForMin(): MaxNativeAdView
    {
        val binder: MaxNativeAdViewBinder =
            MaxNativeAdViewBinder.Builder(R.layout.savemasterdown_native_min_layout)
                .setTitleTextViewId(R.id.savemasterdown_nativetitletextview)
                .setAdvertiserTextViewId(R.id.savemasterdown_nativeadvertisertextview)
                .setIconImageViewId(R.id.savemasterdown_min_native_icon)
                .setOptionsContentViewGroupId(R.id.savemasterdown_optionsview)
                .setBodyTextViewId(R.id.savemasterdown_nativebodytextview)
                .setCallToActionButtonId(R.id.savemasterdown_nativeadaction)
                .build()
    ...
    private fun createNativeAdViewForBig(): MaxNativeAdView{
        ...
        var builderExtend = ApproveNativeBuilder(R.layout.savemasterdown_native_big_layout)
        builderExtend.setTitleTextViewId(R.id.savemasterdown__title_text_view)
        builderExtend.setAdvertiserTextViewId(R.id.savemasterdown_advertiser_text_view)
        builderExtend.setBodyTextViewId(R.id.savemasterdown_body_text_view)
        builderExtend.setIconImageViewId(R.id.savemasterdown_icon_image_view)
        builderExtend.setIconContentView(R.id.savemasterdown_icon_view)
        builderExtend.setOptionsContentViewGroupId(R.id.options_view)
        builderExtend.setOptionsContentFrameLayout(R.id.options_view)
        builderExtend.setMediaContentViewGroupId(R.id.savemasterdown_media_content_view)
        builderExtend.setMediaContentFrameLayout(R.id.savemasterdown_media_content_view)
        builderExtend.setCallToActionButtonId(R.id.savemasterdown_cta_button)
